...
export default async function Banner() {
  ...
  return (
    <div
      className="relative w-full h-[420px] sm:h-[480px] md:h-[550px] mt-8 sm:mt-12 px-20 flex items-center justify-center text-center text-white max-w-7xl mx-auto rounded-3xl overflow-hidden shadow-lg"
      style={{
